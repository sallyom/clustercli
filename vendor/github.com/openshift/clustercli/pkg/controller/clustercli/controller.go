...
func NewClusterCLISyncController(
	...
	c := &ClusterCLISyncController{
		...
		// TODO: get from imagestream in cluster if connected
...
//(*ClusterCLISyncController, error) {
//
//	ocStream, err := isClient.Get(ctx, "cli-artifacts", metav1.GetOptions{})
//	if err != nil {
//		if errors.IsNotFound(err) {
...
//		return nil, err
//	}
//	klog.Infof("OCSTREAM: %v", ocStream)
//	ctrl := &ClusterCLISyncController{
//		ctx:              ctx,
//		clusterCLIClient: clusterCLIInterface,
//		// TODO: get from imagestream in cluster if connected
//		odoImage: "quay.io/sallyom/odo:latest",
...
//		ocImage:  ocStream.Spec.Tags[0].From.Name,
//		recorder: recorder,
//		queue:    workqueue.NewNamedRateLimitingQueue(workqueue.DefaultControllerRateLimiter(), "ClusterCLISyncController"),
//	}
//
//	clusterCLIInformers.Informer().AddEventHandler(ctrl.newEventHandler())
//
//	ctrl.cachesToSync = append(ctrl.cachesToSync,
//		clusterCLIInformers.Informer().HasSynced,
//	)
//
//	return ctrl, nil
//}
...
//func (c *ClusterCLISyncController) Run(workers int, stopCh <-chan struct{}) {
...
//		klog.Infof("caches did not sync")
//		kruntime.HandleError(fmt.Errorf("caches did not sync"))
//		return
//	}
...
//func (c *ClusterCLISyncController) runWorker() {
//	for c.processNextWorkItem() {
//	}
//}

//func (c *ClusterCLISyncController) processNextWorkItem() bool {
...
//		return true
//	}
//	kruntime.HandleError(fmt.Errorf("%v failed with : %v", processKey, err))
//	c.queue.AddRateLimited(processKey)
//	return true
//}

//func (c *ClusterCLISyncController) newEventHandler() cache.ResourceEventHandler {
